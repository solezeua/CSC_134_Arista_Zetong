...
@date:06/18/2026
@purpose: program that accepts a year from a user and determines if the year is a leap year. If it's a leap year, then print "The year you entered xxxx is a leap year". If the year is NOT a leap year, then print "The year you entered xxxx is NOT leap year"
*/
